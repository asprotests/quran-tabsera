export default async function handler(req, res) {
  const { from, to, gender, type, teacher, dailyActivity } = req.query;
  ...
  try {
    ...
    if (type === "login") {
      ...
      endpoint = `http://tabsera.com:8585/quran-teacher-report/report?from=${from}&to=${to}&gender=${gender}&dailyActivity=${dailyActivity}`;
    }
